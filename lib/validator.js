...
var SUPPORT_CSS_ENV = ['env(safe-area-inset-top)', 'env(safe-area-inset-bottom)', 'env(safe-area-inset-left)', "env(safe-area-inset-right)"]
...
var LENGTH_VALIDATOR = function LENGTH_VALIDATOR(v) {
  ...
  if (SUPPORT_CSS_ENV.indexOf(v) > -1) {
    return {value: v};
  }
