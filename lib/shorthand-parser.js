...
function padding (declaration) {
  ...
  result.push(
    generateDeclaration('padding-top', splitResult[0], position),
    generateDeclaration('padding-right', splitResult[1], position),
    generateDeclaration('padding-bottom', splitResult[2], position),
    generateDeclaration('padding-left', splitResult[3], position)
  )
  return result
}
